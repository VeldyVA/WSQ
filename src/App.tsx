...
function App() {
  ...
  const getInterpretation = (score: number) => {
    if (score <= 28) return {
      level: t.interpretation.lowStress.level,
      description: t.interpretation.lowStress.description,
    ...
    if (score <= 40) return {
      level: t.interpretation.moderateStress.level,
      description: t.interpretation.moderateStress.description,
    ...
    if (score <= 52) return {
      level: t.interpretation.highStress.level,
      description: t.interpretation.highStress.description,
